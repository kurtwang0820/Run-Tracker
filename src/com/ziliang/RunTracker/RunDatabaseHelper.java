...
public class RunDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_LOCATION_LATITUE="latitude";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table location (timestamp integer, latitude real, longitude read, " +
    ...
    public long insertLocation(long runId,Location location){
        ContentValues cv=new ContentValues();
        cv.put(COLUMN_LOCATION_LATITUE,location.getLatitude());
    ...
    public RunCursor queryRun(){
        //equivalent to select * from run order by start_date asc(ascending order)
    ...
    /**
     * a convenient class to wrap a cursor that returns rows from the run table
    ...
    public static class RunCursor extends CursorWrapper{
        ...
        /**
         * return a run object configured for current row or null if the row is invalid
         */
        public Run getRun(){
    ...
    public static class LocationCursor extends CursorWrapper{
        ...
        public Location getLocation(){
            ...
            location.setLatitude(getDouble(getColumnIndex(COLUMN_LOCATION_LATITUE)));
